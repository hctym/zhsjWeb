...
<div class="form-horizontal ajaxfrom" role="form" id="form-user">
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<input type="text" class="form-control" id="shopName" value="" placeholder="门店名称">
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<select name="storetype" id="shopType" class="form-control">
							<option value="0">
								特约门店
							</option>
							<option value="1">
               ...
               <div class="form-group">
					...
					<div class="col-sm-10 col-lg-9 col-xs-12">
								<label class="radio-inline"><input type="radio" name="iscooperate" value="0" checked> 否</label>
								<label class="radio-inline"><input type="radio" name="iscooperate" value="1" > 是</label>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<input type="text" class="form-control" id="contact" value="" placeholder="联系人">
						<div class="help-block">
							请填写门店联系人
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8 col-lg-9 col-xs-12">
						<input type="text" class="form-control" id="contactPhone" value="" placeholder="联系电话">
						<div class="help-block">
							请填写门店联系电话
						</div>
					</div>
		...
		<div class="input-group " style="margin-top:.5em;">
			...
			<em class="close" style="position:absolute; top: 0px; right: -14px;" title="删除这张图片" onclick="deleteImage(this)">×</em>
				...
				<div class="form-group">
					...
					<input type="text" id="iszx" value="0">
				</div>
					   <div class="form-group">
