...
<body>
  <div class="wrapper">
	  ...
	  <div class="topnav">
	     ...
	     <div class="nav">
	       <ul>
	          ...
	          <li>
	             <a href="page/userManager" target="center">账号设置</a>      
	          </li>
	          <li>
	  ...
	  <!-- 主内容 -->
	  <div class="content">
	      <iframe id="mainIframe" scrolling="no" frameborder="0" src="page/userManager" name="center" width="100%" border="0" marginwidth="0" marginheight="0" "></iframe>
	  </div>
	  <!-- footer -->
	  <div class="footer">
